<template>
  <div>
    <el-row type="flex" :gutter="20" style="padding-left: 20px">
      <h2 class="subtitle" style="margin-top: 20px; margin-left: 5px"> 自由报表 </h2>
    </el-row>
    <el-row style="height: auto;margin: 0 10px">
      <iframe scrolling="no" frameborder="0" id="reportFrame" :src="src"></iframe>
    </el-row>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      src: reportURL + 'freeReport%252FfreeReport.cpt' + '&__bypagesize__=false'
    }
  },
  methods: {
